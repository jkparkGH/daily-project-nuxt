  ...
  <section>
    ...
    <div class="common-item-box">
      <ul class="coperation-list">
        <li>
          <a href="#_" aria-label="Ralph-Lauen link" title="Ralph-Lauen link">
            <img
              src="~@/assets/images/logo1_image.png"
              alt="Ralph-Lauen logo image"
            />
          </a>
        </li>
        <li>
          <a
            href="#_"
            aria-label="TOMMY-HILFIGER link"
        ...
        <li>
          <a
            href="#_"
            aria-label="DAVIDOFF link"
            ariatitlelabel="DAVIDOFF link"
          >
            <img
              src="~@/assets/images/logo3_image.png"
              alt="DAVIDOFF logo image"
            />
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="#_" aria-label="HUGO-BOSS link" title="HUGO-BOSS link">
            <img
              src="~@/assets/images/logo5_image.png"
              alt="HUGO-BOSS logo image"
            />
          </a>
        </li>
        <li>
          <a href="#_" aria-label="ESCADA link" title="ESCADA link">
            <img
              src="~@/assets/images/logo6_image.png"
              alt="ESCADA logo image"
            />
          </a>
        </li>
      </ul>
